import HautevilleHouse.ComputationalStabilityErrorCorrectingCodesCanonicalLaneLean.ReviewerBridge
...
def sourceTheoremStatement : TheoremStatement := {
  ...
  classicalBoundary := "Unrestricted error-correcting codes with unbounded distance",
